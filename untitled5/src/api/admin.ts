...
export const adminApi = {
  ...
  getDepartmentStats: async (params?: { startDate?: string; endDate?: string }) => {
    return await api.get('/admin/stats/departments', { params });
  },

  getDailyAppointmentStats: async (params?: { startDate?: string; endDate?: string }) => {
    return await api.get('/admin/stats/daily-appointments', { params });
  },

  getDoctorWorkload: async (params?: { startDate?: string; endDate?: string }) => {
    return await api.get('/admin/stats/doctor-workload', { params });
  }
};

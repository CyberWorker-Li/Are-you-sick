...
public interface AppointmentRepository extends JpaRepository<Appointment, Long> {
    ...
    long countByStatusAndAppointmentTimeBetween(Appointment.AppointmentStatus status,
                                                LocalDateTime start,
                                                LocalDateTime end);

    long countByDoctorIdInAndAppointmentTimeBetween(List<Long> doctorIds,
                                                    LocalDateTime start,
                                                    LocalDateTime end);

    long countByDoctorIdAndAppointmentTimeBetween(Long doctorId,
                                                  LocalDateTime start,
                                                  LocalDateTime end);

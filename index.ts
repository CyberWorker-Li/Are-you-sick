...
import DoctorInfoView from '../components/DoctorInfoView.vue'; // 新增导入
import PatientProfile from '../components/PatientProfile.vue';
import patientApi from '../api/patient';  // 确保这行存在
...
const routes: Array<RouteRecordRaw> = [
    ...
    },
    {
        path: '/doctor-info',
        name: 'DoctorInfo',
        component: DoctorInfoView, // 使用导入的组件
        meta: { requiresAuth: true }
    },
    {
      path: '/patient',  // 路径是 /patient
      name: 'PatientDashboard',  // 名称是 PatientDashboard
      component: PatientDashboard,
      meta: { requiresAuth: true, role: 'PATIENT' }
    },
    {
